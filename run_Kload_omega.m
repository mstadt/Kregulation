...
% simulation 2 (dt K secretion MKX, omega = 0.1)
disp('get sim 2 SS')
pars2 = set_params();
...
MKX_slope = 0.1; % 0.1 is dtKsec mKic value
...
% simulation 3 (dt K secretion MKX, omega = 0.05)
disp('get sim 3 SS')
pars3 = set_params();
...
% simulation 4 (dt K secretion, omega = 0.15)
disp('get sim 4 SS')
pars4 = set_params();
...
if do_plt
    ...
    labels{2} = 'MKX-DT-sec m_{Kic} = 0.10';
    labels{3} = 'MKX-DT-sec m_{Kic} = 0.05';
    labels{4} = 'MKX-DT-sec m_{Kic} = 0.15';
