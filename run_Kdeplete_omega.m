...
% simulation 4 (dt K sec MKX, mKic = 0.15)
disp('get sim 4 SS')
pars4 = set_params();

Kin4.Kin_type = 'long_simulation';
Kin4.Meal = 1;
Kin4.KCL = 1;
...
MealInfo4.K_amount = 100/3;
MealInfo4.meal_type = 'Kdeplete';
...
if do_plt
    ...
    labels{2} = 'MKX-DT-sec m_{Kic} = 0.1';
