function plot_4_sims(T,X,params,Kin_opts,labels,MealInfo,days)
% plots to do
plt_6_panels = 1;
plt_Kconc_plas_IC = 1;
...
c4 = [0.8500 0.3250 0.0980]; % orange %[0.6350 0.0780 0.1840]; % maroon %green %[0.4940 0.1840 0.5560]; % purple
